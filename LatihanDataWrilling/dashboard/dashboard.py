...
#untuk menyiapkan daily_orders_df
...
# untuk mendukung hal ini, kita perlu mengurutkan DataFrame berdasarkan order_date serta memastikan kedua kolom tersebut bertipe datetime.
...
#informasi tentang jumlah order harian ditampilkan dalam bentuk visualisasi data
...
#memasukkan ketiganya ke dalam dashboard 
